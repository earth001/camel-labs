 ...
 * generated in the com.redhat.gpte.training package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCustomerByName_QNAME = new QName("http://training.gpte.redhat.com/", "getCustomerByName");
    private final static QName _GetCustomerByNameResponse_QNAME = new QName("http://training.gpte.redhat.com/", "getCustomerByNameResponse");
    private final static QName _GetAllCustomers_QNAME = new QName("http://training.gpte.redhat.com/", "getAllCustomers");
    private final static QName _GetAllCustomersResponse_QNAME = new QName("http://training.gpte.redhat.com/", "getAllCustomersResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://training.gpte.redhat.com/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://training.gpte.redhat.com/", "saveCustomerResponse");
    private final static QName _NoSuchCustomer_QNAME = new QName("http://training.gpte.redhat.com/", "NoSuchCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.redhat.gpte.training
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "getCustomerByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "getCustomerByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "getAllCustomers")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "getAllCustomersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "saveCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "saveCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://training.gpte.redhat.com/", name = "NoSuchCustomer")
